...
import Navbar from "./Navbar";import Darkmode from "darkmode-js";
  ...
  role: 'button'
    ...
    <img src={f.preview} />
        ...
        <div className='invisible md:visible lg:h-[305px] lg:mx-32 my-40 bg-contain w-[550px]' style={{ backgroundImage:`url(${bg2})` }}>
            <p className='font-semibold text-white md:ml-36 md:mt-16 lg:ml-52 lg:mt-20 text-sm lg:text-lg w-32'>Upload Video</p>
        </div>
    </div>
